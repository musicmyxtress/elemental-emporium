...
export const CREATURES: Creature[] = [
  ...
  },
  {
    id: "hawk",
    name: "Hawk",
    description: "a sharp-eyed raptor with a hooked beak, broad wings, and rust-streaked tail feathers.",
    rarity: 1,
    level: 1,
    gender: "male",
    magical: false,
  ...
  },
  {
    id: "bee",
    name: "Bee",
    description: "a plump, fuzzy-bodied insect with transparent wings, amber-striped abdomen, and pollen-dusted legs.",
    rarity: 1,
    level: 1,
    gender: "female",
    magical: false,
  ...
  },
  {
    id: "firefly",
    name: "Firefly",
    description: "a slender beetle with delicate wings and a pale abdomen that pulses with a soft golden glow.",
    rarity: 1,
    level: 1,
    gender: "male",
    magical: false,
...
/** Maximum HP for a creature. HP = (rarity + level) × 3. */
